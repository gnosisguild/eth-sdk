...
import mainnet_withGasFields_abi from '../../eth-sdk/abis/mainnet/withGasFields.json';
...
export function getMainnetSdk(defaultSignerOrProvider) {
    return {
        ...
        "withGasFields": getContract('0xbEbc44782C7dB0a1A60Cb6fe97d0b483032FF1C7', mainnet_withGasFields_abi, defaultSignerOrProvider),
        "proxies": {
